...
public class Exercises {
    ...
    public String makeTags(String tag, String word) {
        ...
        char b = '<';
        char c = '/';
        String answer = i + tag + a + word + i + c + tag + a;
        return answer;
    }
    ...
    public String extraEnd(String str) {
        ...
        String answer = str.substring(str.length() - 2) + str.substring(str.length());
    ...
    public String firstTwo(String str) {
        if (str.length() > 2) {
            String answer = str.substring(0, 1) + str.substring(1, 2);
            return answer;
        }
        return str;
...
//        for (int i =0; i < str.length(); i++);
    ...
    public String nTwice(String str, int n) {
        String answer = (str.substring(0, n)) + str.substring(str.length() - n);
        return answer;
    }
    ...
    public boolean hasBad(String str) {
        if (str.length() == 3 && str.equals("bad")) {
            ...
            if (str.substring(0, 1).equals("bad")) {
                return true;
            }
