...
public class Exercises {
    ...
    public String animalGroupName(String animalName) {
        Map<String, String> animalMaps = new HashMap<>();
        animalMaps.put("rhino", "Crash");
        animalMaps.put("giraffe", "Tower");
        animalMaps.put("elephant", "Herd");
        animalMaps.put("lion", "Pride");
        animalMaps.put("crow", "Murder");
        animalMaps.put("pigeon", "Kit");
        animalMaps.put("flamingo", "Pat");
        animalMaps.put("deer", "Herd");
        animalMaps.put("dog", "Pack");
        animalMaps.put("crocodile", "float");
        ...
        if (animalMaps.containsKey(animalName.toLowerCase())) {
            return animalMaps.get(animalName.toLowerCase());
        }
    ...
    public double isItOnSale(String itemNumber) {
        ...
        if (discountMap.containsKey(itemNumber.toUpperCase())) {
    ...
    public Map<String, Integer> robPeterToPayPaul(Map<String, Integer> peterPaul) {
       //if peter has more than 0 money and paul has less that $10 then transfer half of peters money to paul
